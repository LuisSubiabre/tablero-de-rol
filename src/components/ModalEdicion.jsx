...
const ModalEdicion = ({ ficha, isOpen, onClose, onSave }) => {
            ...
            <div className="hp-inputs">
              <div className="hp-input-group">
                ...
                <input
                  ...
                  value={hpActualFicha}
                  onChange={(e) =>
                    setHpActualFicha(Math.max(0, parseInt(e.target.value) || 0))
                  }
                  className="input-hp"
                />
              </div>
              ...
              <div className="hp-input-group">
                ...
                <input
                  ...
                  value={hpMaxFicha}
                  onChange={(e) => {
                    const nuevoMax = Math.max(1, parseInt(e.target.value) || 1);
